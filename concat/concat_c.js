...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'concat_c.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'concat_c.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'concat_c.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "concat_c.html.mem" : null;
...
var real__concat_c = asm["_concat_c"]; asm["_concat_c"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__concat_c.apply(null, arguments);
};
Module["asm"] = asm;
...
var _concat_c = Module["_concat_c"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_concat_c"].apply(null, arguments) };
