...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'callback_twice.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'callback_twice.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'callback_twice.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "callback_twice.js.mem" : null;
...
var real__callback_twice_c = asm["_callback_twice_c"]; asm["_callback_twice_c"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__callback_twice_c.apply(null, arguments);
};
...
var _callback_twice_c = Module["_callback_twice_c"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_callback_twice_c"].apply(null, arguments) };
