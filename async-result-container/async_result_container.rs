...
#[no_mangle]
pub fn async_result_container_set (
    ptr: *mut AsyncResultContainer, v: *const c_char) {
...
pub fn exec_async_c(callback: extern "C" fn(*const c_char)) {
    let container = Box::into_raw(Box::new(AsyncResultContainer::new())) as *mut AsyncResultContainer;
