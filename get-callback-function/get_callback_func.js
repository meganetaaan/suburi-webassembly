...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'get_callback_func.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'get_callback_func.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'get_callback_func.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "get_callback_func.js.mem" : null;
...
var real__get_callback_func = asm["_get_callback_func"]; asm["_get_callback_func"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__get_callback_func.apply(null, arguments);
};
...
var _get_callback_func = Module["_get_callback_func"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_get_callback_func"].apply(null, arguments) };
