...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'fibonacci.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'fibonacci.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'fibonacci.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "fibonacci.html.mem" : null;




var STATIC_BUMP = 15584;
