...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'emscripten_sleep.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'emscripten_sleep.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'emscripten_sleep.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "emscripten_sleep.js.mem" : null;




var STATIC_BUMP = 14496;
...
Module['wasmTableSize'] = 8320;

Module['wasmMaxTableSize'] = 8320;
